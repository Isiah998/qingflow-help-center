...
ARG BUILD_COMMIT=""
ARG TYPESENSE_HOST=""
ARG TYPESENSE_SEARCH_HOST=/typesense
ARG TYPESENSE_COLLECTION=qingflow_help_docs
ARG TYPESENSE_SEARCH_API_KEY=""
ARG TYPESENSE_ENABLE_SEMANTIC=false
ARG OUTLINE_URL=https://outline.qingflow.com
ARG OUTLINE_COLLECTION=售后知识库(公开)
...
ENV DOCS_URL=${DOCS_URL} \
    ...
    TYPESENSE_SEARCH_HOST=${TYPESENSE_SEARCH_HOST} \
